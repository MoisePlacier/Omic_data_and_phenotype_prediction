...
« Au-delà de la structuration globale entre les bassins versants, il existe une structure plus subtile à l'échelle locale. Pour la capturer, nous utilisons une matrice de parenté (K), ou Kinship matrix, estimée via l'estimateur de Yang et al. (2011).

$$K = \frac{Z{Z}^T}{N}$$
avec : ${Z}$ la matrice centrée et réduite des marqueurs moléculaires considérés et ${N}$ le nombre de marqueurs moléculaires

Cette matrice permet de modéliser :
