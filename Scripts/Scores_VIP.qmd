...
comparer les vip sur le subset avec vip sur full dataset

ajouter en covariable les première composante de la structure de la population =\>
...
run_pls_analysis <- function(task, X, y, save_dir) {
  ...
  # Entraîner et comparer ncomp=2 et ncomp=3 pour éviter un protocole CV complet ... 
...
```{r}
SAVE_DIR <- "results_performances_subset/results_random_VIP_PLS"
...
## table VIP fusionnée avec la localisation
