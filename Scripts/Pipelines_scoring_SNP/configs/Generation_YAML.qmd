...
on au total $p = 217{,}000$ SNPs. Ensuite ![Performance de la PLS pour le phénotype CIRC2009 en fonction de la taille du subset](../Plots/Performance_PLS_Subset_Size.png) 5000 SNP est un bon compromis entre taille du subset et performance prédictive
